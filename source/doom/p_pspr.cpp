...
void P_FireWeapon(player_t* player)
{
    ...
    auto newstate = weaponinfo[player->readyweapon].atkstate;
    P_SetPsprite(player, ps_weapon, newstate);
    ...
    pspdef_t* psp)
{
    ...
    auto newstate = weaponinfo[player->readyweapon].readystate;
    P_SetPsprite(player, ps_weapon, newstate);
}
...
// A_FirePlasma
//
void A_FirePlasma(player_t* player, [[maybe_unused]] pspdef_t* psp)
{
    player->ammo[weaponinfo[player->readyweapon].ammo]--;

    P_SetPsprite(player, ps_flash, static_cast<statenum_t>(weaponinfo[player->readyweapon].flashstate + (P_Random() & 1)));
